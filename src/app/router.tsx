  ...
  return (
    <Routes>
      ...
      <Route element={<AuthGuard />}>
        {/* 상세 조회 (View 진입) */}
        <Route path="/order/reservation/:wrkRcpNo/:reservationDate" element={<OrderDetailViewPage />} />
        {/* 변경 직진 (카카오 [예약 변경] 버튼) — 같은 컴포넌트, 초기 step만 다름 */}
        <Route path="/order/reservation/:wrkRcpNo/:reservationDate/change" element={<OrderDetailViewPage />} />
        {/* 당일 작업자 정보 */}
